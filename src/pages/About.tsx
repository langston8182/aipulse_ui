  ...
  return (
      <div className="min-h-screen bg-gray-50">
        <Helmet>
          ...
          <meta name="description" content={`Découvrez ${config.siteTitle}, votre source d'actualités sur l'intelligence artificielle et les technologies émergentes.`} />
          <meta name="keywords" content="à propos, AI Pulse News, intelligence artificielle, actualités IA, contact" />
          <meta property="og:title" content={`À propos - ${config.siteTitle}`} />
          <meta property="og:description" content={`Découvrez ${config.siteTitle}, votre source d'actualités sur l'intelligence artificielle et les technologies émergentes.`} />
